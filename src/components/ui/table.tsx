...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-slate-800/50 transition-colors hover:bg-indigo-500/[0.04] data-[state=selected]:bg-slate-800',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-4 py-3 align-middle [&:has([role=checkbox])]:pr-0 text-slate-200', className)}
    {...props}
  />
))
